...
export default function WalkInCustomersPage() {
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        <div>
          <button onClick={() => window.location.href = '/delivery/dashboard'} style={{ background: "none", border: "none", color: "#a0a0a0", cursor: "pointer", display: "flex", alignItems: "center", gap: "8px", fontWeight: 700, fontSize: "0.9rem", padding: "0 0 12px 0", fontFamily: "inherit" }}><ArrowLeft size={18} /> Back to Dashboard</button>
          <h1
            style={{
              fontSize: "1.8rem",
              fontWeight: 900,
