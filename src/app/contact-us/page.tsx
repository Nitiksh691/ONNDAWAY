        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16, marginTop: 20 }}>
          ...
          <div className="contact-card" style={{ animationDelay: "0.1s" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
              ...
              <h2 style={{ fontSize: "0.85rem", fontWeight: 800, color: "#2A3060", textTransform: "uppercase", letterSpacing: "0.8px" }}>Order Support</h2>
            </div>
            <p style={{ fontSize: "0.88rem", color: "#6B7280", lineHeight: 1.65, marginBottom: 16 }}>
              For faster assistance with an existing order, please keep your <strong style={{ color: "#0A0F2E" }}>Order ID</strong> ready.
            </p>
            <div style={{ fontSize: "0.82rem", color: "#6B7280", lineHeight: 1.8 }}>
              When contacting us, please provide:
              <div style={{ display: "flex", flexDirection: "column", gap: 6, marginTop: 10 }}>
                {["Order ID", "Your name", "Phone number used for order", "Description of the issue"].map(item => (
                  <div key={item} style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#0135FB", flexShrink: 0 }} />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
          ...
          {/* What We Help With */}
          <div className="contact-card" style={{ animationDelay: "0.15s" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
              <Package size={18} color="#0135FB" />
              <h2 style={{ fontSize: "0.85rem", fontWeight: 800, color: "#2A3060", textTransform: "uppercase", letterSpacing: "0.8px" }}>Common Support Requests</h2>
            </div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {[
                "Order status", "Delivery issues", "Missing items",
                "Damaged products", "Payment issues", "Cancellation requests",
                "Refund requests", "Product questions",
              ].map(tag => (
          ...
          <div className="contact-card" style={{ animationDelay: "0.2s" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 18 }}>
              ...
              <h2 style={{ fontSize: "0.85rem", fontWeight: 800, color: "#2A3060", textTransform: "uppercase", letterSpacing: "0.8px" }}>Business Info</h2>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <div className="contact-method-link" style={{ cursor: "default" }}>
                <MapPin size={16} color="#0135FB" style={{ flexShrink: 0 }} />
                <div>
                  <div style={{ fontSize: "0.7rem", color: "#9ca3af", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.5px" }}>Location</div>
                  <div style={{ fontWeight: 700, color: "#0A0F2E", fontSize: "0.9rem" }}>Rohini, Delhi</div>
                </div>
              </div>
              <div className="contact-method-link" style={{ cursor: "default" }}>
                <Clock size={16} color="#0135FB" style={{ flexShrink: 0 }} />
                <div>
                  <div style={{ fontSize: "0.7rem", color: "#9ca3af", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.5px" }}>Delivery Area</div>
                  <div style={{ fontWeight: 700, color: "#0A0F2E", fontSize: "0.9rem" }}>Rohini & nearby campus areas</div>
                </div>
              </div>
            </div>
          </div>
